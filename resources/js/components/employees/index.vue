  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <router-link :to="{ name: 'store-employees' }" class="btn btn-primary">Tambah Karyawan</router-link>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Data Karyawan</a></li>
              <li class="breadcrumb-item active">Semua Karyawan</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr v-for="employee in searchData" :key="employee.id">
                    ...
                    <td>
                      <router-link :to="{name: 'edit-employees', params:{id:employee.id}}" class="btn btn-success">Edit</router-link>
                      <a @click="deleteEmployee(employee.id)" class="btn btn-danger"><font color="#fffff">Delete</font></a>
                    </td>
                  </tr>
                </tbody>
              </table>
